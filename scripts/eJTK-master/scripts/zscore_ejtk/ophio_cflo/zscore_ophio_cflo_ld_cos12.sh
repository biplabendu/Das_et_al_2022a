...
data_path=~/Documents/GitHub/Das_et_al_2022a/results/normalized_gene_exp/zscore/ophio_cflo/
# specify the data file 
#################################################
	# species: ophio_cflo
	# dataset: ld (z-score)
data=ophio_cflo_zscores_noNAs.txt
#################################################
# specify the identifier for the output files
output_name=cos12_ph0020by4_as0420by4_zscore
