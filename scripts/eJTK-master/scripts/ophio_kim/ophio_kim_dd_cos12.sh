...
data_path=~/Documents/GitHub/Das_et_al_2022a/results/normalized_gene_exp/ophio_kim/dd/
# specify the data file 
	# species: ophio_kim
	# dataset: dd
data=normalized_gene_exp_ophio_kim_dd_samples.txt
# specify the identifier for the output files
output_name=cos12_ph0020by4_as0420by4
