...
names(l.phases) <- c(sample.name[1:2],sampleName[2])
...
## Save results of not_expressed genes into an excel file
supp <- list(
  "rhy24_ophio_cluster1" = gsoi.2[[1]],
  "rhy24_ophio_cluster2" = gsoi.2[[2]],
  "rhy24_ophio_cluster3" = gsoi.2[[3]],
  "rhy24_ophio_cluster4" = gsoi.2[[4]]
  )
writexl::write_xlsx(supp,
